			...
			<form action="" id="manage-allowances">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Project idea</label>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Project Information</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p>Name of Employee: <b><?php echo $row['allowance'] ?></b></p>
										 <p class="truncate"><small>Project idea: <b><?php echo $row['description'] ?></b></small></p>
									</td>
